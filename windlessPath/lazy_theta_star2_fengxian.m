%lazy theta算法函数（2D）
function [ path,route_node_number,open,close ] = lazy_theta_star2_fengxian(xstart,ystart,xend,yend,mapsize,obstacle,E3d_safe,ellipse_radius,ellipse_midpoint_x,ellipse_midpoint_y)
%环境矩阵(地图)的大小（x y z轴）
x_size=mapsize(1);
y_size=mapsize(2);
% z_size=mapsize(3);
