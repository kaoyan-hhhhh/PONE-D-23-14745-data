%theta算法函数
function [ path,route_node_number,open,close ] = theta_star_heap(xstart,ystart,zstart,xend,yend,zend,mapsize,obstacle,E3d_safe)
                                     ...
                                     if check_close==3 || check_obstacle==3
                                        ...
                                        if check_open<3
                                            ...
                                            if  G_old>G(xcurrent+i,ycurrent+j,zcurrent+k)
                                                if check_open==3
%                                                     neighbor_node=[xcurrent+i,ycurrent+j,zcurrent+k];
...
% 
% %                                                     open=find(current_node~=[xcurrent, ycurrent, zcurrent]);
