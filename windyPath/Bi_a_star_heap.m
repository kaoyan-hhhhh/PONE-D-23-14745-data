%A星算法函数（三维）
%加入最小堆的A*算法
function [ path,route_node_number,open,close ] = Bi_a_star_heap(xstart,ystart,zstart,xend,yend,zend,mapsize,obstacle)
...
%正向
open1=[xstart,ystart,zstart,F(xstart,ystart,zstart)];
%反向
open2=[xend,yend,zend,F(xend,yend,zend)];
