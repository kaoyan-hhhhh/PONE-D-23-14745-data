%theta算法函数
function [ path,route_node_number,open,close ] = theta_star2(xstart,ystart,xend,yend,mapsize,obstacle,E3d_safe,ellipse_radius,ellipse_midpoint_x,ellipse_midpoint_y)
...
%                                             came_fromz(xcurrent+i,ycurrent+j,zcurrent+k)=0;
                                            ...
                                            xb=[came_fromx(xcurrent,ycurrent) xcurrent+i];
                                            yb=[came_fromy(xcurrent,ycurrent) ycurrent+j];
...
%                                                     came_fromz(xcurrent+i,ycurrent+j,zcurrent+k)=came_fromz(xcurrent,ycurrent,zcurrent);
                                                    ...
                                                    F(xcurrent+i,ycurrent+j)=G(xcurrent+i,ycurrent+j)+gf*H;
